...
The biomes ‘Temperate midlatitudes’ and ‘Subtropics with winter rain’ have 37,507 and 16,510 vegetation plots, respectively, while none of the other biomes has more than 10,000 vegetation plots (Figure {@fig:Figure2}). Yet all Whittaker biomes are covered by sPlot Open.
...
In short, a plot record was considered a forest if the cover of the tree layer, or, the sum of the relative cover of all tree taxa (normalized to 100%), was greater than 25%. It was instead considered a non-forest record if the sum of the relative cover of low‐stature, non‐tree and non‐shrub taxa was greater than 90%. 
